...
import com.sheke.walking.model.Role;
...
import com.sheke.walking.registration.email.EmailSender;
...
public class RegistrationService {
	...
	public RegistrationService(EmailValidator emailValidator,
			EmployeeService employeeService, ConfirmationTokenService confirmationTokenService,EmailSender emailSender) {
    ...
    public String confirmToken(String token) {
        ...
        employeeService.enableEmployeeUser(
